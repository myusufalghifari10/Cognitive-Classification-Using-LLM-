...
Delapan model LLM diuji pada 120 postingan forum diskusi mahasiswa menggunakan prompt few-shot (`prompts/system_few_shot.md`) dan zero-shot (`prompts/system_zero_shot.md`). Seluruh evaluasi menggunakan `seed=42` dan sampling default server.
...
- Beberapa model memerlukan penyesuaian konteks & budget token (Nanbeige & Qwythos: thinking sangat panjang; KAT & Gemma: `json_schema`; Qwen apex: `none`).
